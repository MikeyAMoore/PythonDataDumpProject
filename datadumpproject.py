...
for company in data:
  for company_name, value in company.items():
    print(company_name)
    for email in value:
      split_email = email.split()
      company_address = split_email[0]
      company_department = split_email[1]        
      company_data = f'{company_address}, dept: {company_department}'
      print(company_data)
